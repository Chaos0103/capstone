...
public class TestDataInit {
    ...
    private void initPatient(Address address) throws Exception {
        Information info = new Information("세종대", "010101", "1000000", "01011111111", address);
    ...
    private void initDoctor(Address address) throws Exception {
        Information info1 = new Information("이익준", "990101", "1000000", "01022222222", address);
        Information info2 = new Information("채송화", "990202", "2000000", "01033333333", address);
        Information info3 = new Information("김준환", "990303", "1000000", "01044444444", address);
        Information info4 = new Information("안정원", "990404", "1000000", "01055555555", address);
        Information info5 = new Information("양석형", "990505", "1000000", "01066666666", address);
